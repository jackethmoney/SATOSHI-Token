(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@babel/runtime/helpers/typeof'), require('number-to-bn'), require('lodash'), require('utf8'), require('randombytes'), require('bn.js'), require('eth-lib/lib/hash'), require('lodash/map'), require('lodash/has')) :
    typeof define === 'function' && define.amd ? define(['exports', '@babel/runtime/helpers/typeof', 'number-to-bn', 'lodash', 'utf8', 'randombytes', 'bn.js', 'eth-lib/lib/hash', 'lodash/map', 'lodash/has'], factory) :
    (global = global || self, factory(global.Rsk3Utils = {}, global._typeof, global.numberToBN, global.lodash, global.utf8, global.randombytes, global.BN, global.Hash, global.map, global.has));
}(this, (function (exports, _typeof, numberToBN, lodash, utf8, randombytes, BN, Hash, map, has) { 'use strict';

    _typeof = _typeof && Object.prototype.hasOwnProperty.call(_typeof, 'default') ? _typeof['default'] : _typeof;
    numberToBN = numberToBN && Object.prototype.hasOwnProperty.call(numberToBN, 'default') ? numberToBN['default'] : numberToBN;
