...
import { isNumber, isObject, isBoolean, isArray, isString } from 'lodash';
...
const getUnitValue = unit => {
  ...
  if (!unitMap[unitLowercase]) {
    throw new Error(`This unit "${unitLowercase}" doesn't exist, please use the one of the following units${JSON.stringify(unitMap, null, 2)}`);
  }
...
export { asciiToHex, bytesToHex, checkAddressChecksum, asciiToHex as fromAscii, numberToHex as fromDecimal, utf8ToHex as fromUtf8, fromWei$1 as fromWei, getSignatureParameters, hexToAscii, hexToBytes, hexToNumber, hexToNumberString, hexToUtf8 as hexToString, hexToUtf8, isAddress, isBN, isHex, isHexStrict, jsonInterfaceMethodToString, keccak256, padLeft as leftPad, numberToHex, padLeft, padRight, randomHex, padRight as rightPad, keccak256 as sha3, soliditySha3, utf8ToHex as stringToHex, stripHexPrefix, hexToAscii as toAscii, toBN, toChecksumAddress, hexToNumber as toDecimal, toHex, toTwosComplement, hexToUtf8 as toUtf8, toWei$1 as toWei, unitMap$1 as unitMap, utf8ToHex };
