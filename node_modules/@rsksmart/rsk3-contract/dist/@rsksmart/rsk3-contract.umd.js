(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@rsksmart/rsk3-utils'), require('web3-core-helpers'), require('@rsksmart/rsk3-abi'), require('@babel/runtime/helpers/classCallCheck'), require('@babel/runtime/helpers/createClass'), require('lodash/isArray'), require('@babel/runtime/helpers/get'), require('@babel/runtime/helpers/possibleConstructorReturn'), require('@babel/runtime/helpers/getPrototypeOf'), require('@babel/runtime/helpers/inherits'), require('web3-core-method'), require('lodash/isFunction'), require('lodash/isUndefined'), require('lodash/cloneDeep'), require('web3-core-subscriptions'), require('@babel/runtime/helpers/assertThisInitialized'), require('web3-core')) :
    typeof define === 'function' && define.amd ? define(['exports', '@rsksmart/rsk3-utils', 'web3-core-helpers', '@rsksmart/rsk3-abi', '@babel/runtime/helpers/classCallCheck', '@babel/runtime/helpers/createClass', 'lodash/isArray', '@babel/runtime/helpers/get', '@babel/runtime/helpers/possibleConstructorReturn', '@babel/runtime/helpers/getPrototypeOf', '@babel/runtime/helpers/inherits', 'web3-core-method', 'lodash/isFunction', 'lodash/isUndefined', 'lodash/cloneDeep', 'web3-core-subscriptions', '@babel/runtime/helpers/assertThisInitialized', 'web3-core'], factory) :
    (global = global || self, factory(global.Rsk3Contract = {}, global.Utils, global.web3CoreHelpers, global.rsk3Abi, global._classCallCheck, global._createClass, global.isArray, global._get, global._possibleConstructorReturn, global._getPrototypeOf, global._inherits, global.web3CoreMethod, global.isFunction, global.isUndefined, global.cloneDeep, global.web3CoreSubscriptions, global._assertThisInitialized, global.web3Core));
}(this, (function (exports, Utils, web3CoreHelpers, rsk3Abi, _classCallCheck, _createClass, isArray, _get, _possibleConstructorReturn, _getPrototypeOf, _inherits, web3CoreMethod, isFunction, isUndefined, cloneDeep, web3CoreSubscriptions, _assertThisInitialized, web3Core) { 'use strict';
    ...
    var AllEventsFilterEncoder = function (_EventFilterEncoder) {
      ...
      var _super = _createSuper(AllEventsFilterEncoder);
    ...
    var allEventsLogDecoder = function (_EventLogDecoder) {
      ...
      var _super = _createSuper$1(allEventsLogDecoder);
      function allEventsLogDecoder(abiCoder) {
        _classCallCheck(this, allEventsLogDecoder);
        return _super.call(this, abiCoder);
      }
    ...
    var SendContractMethod = function (_EthSendTransactionMe) {
      ...
      var _super = _createSuper$2(SendContractMethod);
      function SendContractMethod(utils, formatters, moduleInstance, transactionObserver, chainIdMethod, getTransactionCountMethod, allEventsLogDecoder, abiModel) {
        ...
        _this = _super.call(this, utils, formatters, moduleInstance, transactionObserver, chainIdMethod, getTransactionCountMethod);
    ...
    var ContractDeployMethod = function (_EthSendTransactionMe) {
      ...
      var _super = _createSuper$4(ContractDeployMethod);
      function ContractDeployMethod(utils, formatters, moduleInstance, transactionObserver, chainIdMethod, getTransactionCountMethod) {
        ...
        return _super.call(this, utils, formatters, moduleInstance, transactionObserver, chainIdMethod, getTransactionCountMethod);
      }
    ...
    var PastEventLogsMethod = function (_GetPastLogsMethod) {
      ...
      var _super = _createSuper$5(PastEventLogsMethod);
    ...
    var AllPastEventLogsMethod = function (_GetPastLogsMethod) {
      ...
      var _super = _createSuper$6(AllPastEventLogsMethod);
    ...
    var EventLogSubscription = function (_LogSubscription) {
      ...
      var _super = _createSuper$7(EventLogSubscription);
      function EventLogSubscription(options, utils, formatters, contract, getPastLogsMethod, eventLogDecoder, abiItemModel) {
        ...
        _this = _super.call(this, options, utils, formatters, contract, getPastLogsMethod);
        _this.eventLogDecoder = eventLogDecoder;
        _this.abiItemModel = abiItemModel;
        return _this;
      }
    ...
    var AllEventsLogSubscription = function (_LogSubscription) {
      ...
      var _super = _createSuper$8(AllEventsLogSubscription);
    ...
    var AbstractContract = function (_AbstractWeb3Module) {
      ...
      var _super = _createSuper$9(AbstractContract);
      function AbstractContract(provider, contractModuleFactory, accounts, abiCoder, utils, formatters) {
        ...
        _this = _super.call(this, provider, options, null, null);
